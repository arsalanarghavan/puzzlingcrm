...
/**
 * Class PuzzlingCRM_Accounting_Person_Category
 */
class PuzzlingCRM_Accounting_Person_Category {

	const TABLE = 'puzzlingcrm_accounting_person_categories';
	...
	public static function delete( $id ) {
		...
		$persons_table = $wpdb->prefix . 'puzzlingcrm_accounting_persons';
