...
const PAGE_TITLES: Record<string, string> = {
  ...
  profile: "پروفایل من",
  accounting: "حسابداری",
  "accounting/persons": "اشخاص (طرف‌های حساب)",
  "accounting/products": "کالا و خدمات",
  "accounting/invoices": "فاکتورها",
  "accounting/cash-accounts": "حساب‌های بانک/صندوق",
  "accounting/receipts": "رسید و پرداخت",
  "accounting/checks": "چک‌ها",
  "accounting/chart": "نمودار حساب‌ها",
  "accounting/journals": "اسناد حسابداری",
  "accounting/ledger": "دفتر کل / معین",
  "accounting/reports": "گزارشات مالی",
  "accounting/fiscal-year": "سال مالی",
