...
const iconMap: Record<string, LucideIcon> = {
  ...
  reports: BarChart3,
  logs: FileStack,
  "visitor-statistics": LineChart,
  settings: Settings,
  profile: User,
  services: Package,
  campaigns: Megaphone,
  accounting: Calculator,
  "accounting-persons": Users,
  "accounting-products": Package,
  "accounting/persons": Users,
  "accounting/products": Package,
  "accounting/invoices": ListOrdered,
  "accounting/cash-accounts": Wallet,
  "accounting/receipts": Receipt,
  "accounting/checks": Banknote,
  "accounting/chart": BookOpen,
  "accounting/journals": FileText,
  "accounting/ledger": Book,
  "accounting/reports": BarChart2,
  "accounting/fiscal-year": Calendar,
