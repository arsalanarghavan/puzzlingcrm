...
$staff_roles = ['system_manager', 'finance_manager', 'team_member', 'administrator']; // Add administrator
    ...
    <div class="pzl-card">
        ...
        <form id="puzzling-add-task-form" class="pzl-form">
            ...
            <div class="form-submit">
                <button type="submit" class="pzl-button pzl-button-primary">افزودن وظیفه</button>
            </div>
        </form>
    </div>
