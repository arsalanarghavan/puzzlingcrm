...
<div class="pzl-dashboard-section">
    <h3><span class="dashicons dashicons-chart-area"></span> گزارش‌ها</h3>

    <div class="pzl-dashboard-tabs">
        <a href="<?php echo add_query_arg(['view' => 'reports', 'tab' => 'finance'], $base_url); ?>" class="pzl-tab <?php echo $active_tab == 'finance' ? 'active' : ''; ?>">گزارش مالی</a>
        <a href="<?php echo add_query_arg(['view' => 'reports', 'tab' => 'tasks'], $base_url); ?>" class="pzl-tab <?php echo $active_tab == 'tasks' ? 'active' : ''; ?>">گزارش وظایف</a>
    </div>
