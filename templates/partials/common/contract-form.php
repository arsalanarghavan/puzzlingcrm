...
<div class="pzl-form-container">
    ...
    <form id="manage-contract-form" class="pzl-ajax-form" data-action="puzzling_manage_contract" method="post" enctype="multipart/form-data">
        ...
        <div class="pzl-form-row">
         ...
         <div class="pzl-form-row">
            <div class="form-group"><label for="_project_start_date">تاریخ شروع:</label><input type="date" id="_project_start_date" name="_project_start_date" value="<?php echo $contract_to_edit ? esc_attr(get_post_meta($contract_to_edit->ID, '_project_start_date', true)) : ''; ?>"></div>
            <div class="form-group"><label for="_project_end_date">تاریخ پایان:</label><input type="date" id="_project_end_date" name="_project_end_date" value="<?php echo $contract_to_edit ? esc_attr(get_post_meta($contract_to_edit->ID, '_project_end_date', true)) : ''; ?>"></div>
        </div>
