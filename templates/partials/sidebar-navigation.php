...
// تعریف منوها بر اساس نقش کاربر
$menu_items = [];

// منوی مدیر سیستم
if ($user_role === 'system_manager') {
    $menu_items = [
        [
            'title' => 'داشبورد',
        ...
        [
            ...
            'url' => add_query_arg('view', 'projects', $dashboard_url),
            'view' => 'projects',
        ],
        [
            'title' => 'مشتریان',
            ...
            'url' => add_query_arg('view', 'customers', $dashboard_url),
            'view' => 'customers',
        ],
        [
            'title' => 'لیدها',
            ...
            'url' => add_query_arg('view', 'leads', $dashboard_url),
            'view' => 'leads',
        ],
        [
            'title' => 'پرسنل',
            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z"></path></svg>',
            'url' => add_query_arg('view', 'staff', $dashboard_url),
            'view' => 'staff',
        ],
        [
            'title' => 'وظایف',
            ...
            'url' => add_query_arg('view', 'tasks', $dashboard_url),
            'view' => 'tasks',
        ],
        [
            'title' => 'قراردادها',
            ...
            'url' => add_query_arg('view', 'contracts', $dashboard_url),
            'view' => 'contracts',
        ],
        [
            'title' => 'پیش‌فاکتورها',
        ...
        [
            ...
            'url' => add_query_arg('view', 'consultations', $dashboard_url),
            'view' => 'consultations',
        ],
        [
            'title' => 'تیکت‌ها',
            ...
            'url' => add_query_arg('view', 'tickets', $dashboard_url),
            'view' => 'tickets',
        ],
        [
            'title' => 'اشتراک‌ها',
            ...
            'url' => add_query_arg('view', 'subscriptions', $dashboard_url),
            'view' => 'subscriptions',
        ],
        [
            'title' => 'گزارشات',
        ...
        [
            ...
            'url' => add_query_arg('view', 'settings', $dashboard_url),
            'view' => 'settings',
        ],
    ];
}
// منوی مدیر مالی
elseif ($user_role === 'finance_manager') {
    $menu_items = [
        [
            'title' => 'داشبورد',
            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"></path></svg>',
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                <?php foreach ($menu_items as $item): 
                    $is_active = ($current_view === $item['view']) ? 'active' : '';
                ?>
                <li class="slide">
                    <a href="<?php echo esc_url($item['url']); ?>" class="side-menu__item <?php echo $is_active; ?>">
                        <?php echo $item['icon']; ?>
                        <span class="side-menu__label"><?php echo esc_html($item['title']); ?></span>
                    </a>
                </li>
                <?php endforeach; ?>
            </ul>
